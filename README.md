...
Go to <https://github.com/YOUR-USERNAME/YOUR-REPOSITORY>, and download the ZIP
...
place it the *Prins et al 2019 MATLAB code* folder that should be located on the
desktop.
...
You can find the example data in *Data\>example_data_local* The CFTRimg_Local.m
script will use the functions in *CFTRimg\>functions Local* to segment and
...
**>> plate(1).image(1)**
	...
	>   redPath: 'C:\Users\USERNAME\Desktop\Prins et al 2019 MATLAB code\Data\example_data_local\TimePoint_1\local_C02_s1_w2.TIF'
	>   yelPath: 'C:\Users\ USERNAME \Desktop\Prins et al 2019 MATLAB code\Data\example_data_local\TimePoint_1\local_C02_s1_w1.TIF'
	>   binning: 0.5000
...
*Data\>quench_Ifirst* and the example data collected with the I<sup>-</sup> last protocol
in *Data\>quench_Ilast.*
